...
@st.cache_data
def load_data():
    df_dashboard = pd.read_excel('staking_rise_dashboard_jogadores.xlsx')
    df_resultados = pd.read_excel('staking_rise_resultados.xlsx', engine='openpyxl')
    df_estatisticas = pd.read_excel("staking_rise_gerais.xlsx")
...
st.set_page_config(page_title="Staking Rise", layout="wide")
